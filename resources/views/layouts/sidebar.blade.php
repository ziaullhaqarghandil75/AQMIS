               ...
               <ul class="nav nav-sidebar" data-nav-type="accordion">
                   ...
                   @can('user_settings')
                       <li class="nav-item nav-item-submenu">
                           ...
                           <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                               @can('view_user')
                                   <li class="nav-item">
                                       <a href="{{ route('owners.create') }}" class="nav-link active">
                                           <i class="fas fa-user"></i> اضافه کردن شخص
                                       </a>
                                   </li>
                               @endcan
                               @can('view_role')
                                   <li class="nav-item">
                                       <a href="{{ route('owners.index') }}" class="nav-link">
                                           <i class="fas fa-users-cog"></i> لیست اشخاص
                                       </a>
                                   </li>
                               @endcan
                           </ul>
                   ...
                   @can('user_settings')
                       <li class="nav-item nav-item-submenu">
                           <a href="#" class="nav-link">
                               <i class="fas fa-user-cog"></i>
                               <span>کټګوری ساختمانی</span>
                           </a>
                           <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                               @can('view_user')
                                   <li class="nav-item">
                                       <a href="{{ route('buildingCategory.create') }}" class="nav-link active">
                                           <i class="fas fa-user"></i> اضافه کردن کتگوری
                                       </a>
                                   </li>
                               @endcan
                               @can('view_role')
                                   <li class="nav-item">
                                       <a href="{{ route('buildingCategory.index') }}" class="nav-link">
                                           <i class="fas fa-users-cog"></i> لیست کټګوری
                                       </a>
                                   </li>
                               @endcan
                           </ul>
                   ...
                   @can('user_settings')
                       <li class="nav-item nav-item-submenu">
                           ...
                           <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                               @can('view_user')
                                   <li class="nav-item">
                                       <a href="{{ route('properties.create') }}" class="nav-link active">
                                           <i class="fas fa-user"></i> اضافه کردن ملکیت
                                       </a>
                                   </li>
                               @endcan
                               @can('view_role')
                                   <li class="nav-item">
                                       <a href="{{ route('properties.index') }}" class="nav-link">
                                           <i class="fas fa-users-cog"></i> لیست ملکیت
                                       </a>
                                   </li>
                               @endcan
                           </ul>
                   ...
                   @can('systems_settings')
                       <li
                           class="nav-item nav-item-submenu {{ menuOpen(['guzar.*', 'block.*', 'zone.*', 'land_category.*']) }}">
