            ...
            <div class="card-body">
                <form action="{{ route('properties.update', $property->id) }}" method="POST">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select-search" data-fouc name="project_id" id="project">
                                    ...
                                    @foreach ($projects as $project)
                                        <option value="{{ $project->id }}" @selected($property->project_id == $project->id)>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select-search" data-fouc name="owner_id" id="owner">
                                    ...
                                    @foreach ($owners as $owner)
                                        <option value="{{ $owner->id }}" @selected($property->owner_id == $owner->id)>
                        ...
                        <div class="col-lg-3 mx-lg-auto">
                            <div class="form-group">
                                <label>property_Parcel_Number</label>
                                <input type="text" name="property_Parcel_Number" class="form-control"
                                    placeholder="ParcelNo" value="{{ $property->property_Parcel_Number ?? '' }}">
                            </div>
                        </div>
                        {{-- property --}}
                        <div class="col-lg-3 mx-lg-auto">
                        ...
                        <div class="col-lg-12 mx-lg-auto">
                            <div class="form-group">
                                ...
                                <textarea name="property_remarks" class="form-control" placeholder="property_remarks" rows="7">{{ $property->property_remarks ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
