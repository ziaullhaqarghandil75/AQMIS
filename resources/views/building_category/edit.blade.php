...
@section('content')
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <!-- Create / Update Form -->
                <form action="{{ route('buildingCategory.update', $buildingCategory->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-10 mx-lg-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="building_Category_unit_Price" class="form-control"
                                    placeholder="building_Category_unit_Price"
                                    value="{{ $buildingCategory->building_Category_unit_Price ?? '' }}">
                            </div>
                        </div>
                    </div>
